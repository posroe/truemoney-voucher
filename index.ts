 ...
 */
export async function VoucherRedeem(phone: string = "", voucherCode: string = ""): Promise<VoucherReturn> {
    phone = phone.trim();
    ...
    const response: VoucherResponse = await fetch(`https://gift.truemoney.com/campaign/vouchers/${extractedCode}/redeem`, {
        method: "POST",
